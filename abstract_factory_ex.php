...
{
    abstract public function createTitleTemplate(): TitleTemplate;

    abstract public function createPageTemplate(): PageTemplate;
    
    abstract public function getRenderer(): TemplateRenderer;
...
class PHPTemplateFactory extends TemplateFactory
{
    ...
    public function createFooterTemplate() : FooterTemplate{ 
        return new PHPTemplateFooterTemplate();
    }
}
...
class PHPTemplateFooterTemplate implements FooterTemplate{
...
abstract class BasePageTemplate implements PageTemplate
{
    ...
    public function __construct(TitleTemplate $titleTemplate, FooterTemplate $footerTemplate = null)
    {
...
class PHPTemplatePageTemplate extends BasePageTemplate
{
    ...
    {
        $renderedTitle = $this->titleTemplate->getTemplateString();
        $renderedFooter = $this->footerTemplate->getTemplateString();
...
class Page
{
    ...
    {
        $pageTemplate = $factory->createFooterTemplate();
 ...
 * any type.
 */
$page = new Page('Sample page', 'This it the body.', 'By Abstract Factory');
